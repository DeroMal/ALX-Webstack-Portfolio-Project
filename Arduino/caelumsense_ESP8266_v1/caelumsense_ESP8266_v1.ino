...
void setup() {
  Serial.begin(9600);      // Starting the serial communication with a baud rate of 9600
  esp.begin(9600);         // Starting the SoftwareSerial communication with a baud rate of 9600
