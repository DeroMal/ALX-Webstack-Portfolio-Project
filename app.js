    ...
    try {
        ...
        while (responseText.trim().length < 10 && attempts < 5) {
            ...
            const response = await openai.createCompletion({
                ...
                prompt: `I am a knowledgeable Caelum (AI) and created by Derrick L. Mayiku. I only so far have access to the following data (Temperature and Humdity) with the timestamps:\n${dataDescription}\nUser: ${question}\nCaelum (AI):`,
                max_tokens: 500,
                n: 1,
                stop: ["\n"],
            });
